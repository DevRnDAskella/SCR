...
//             ${data.flight.flightType}/${PHRASE_TERMINAL_ARRIVAL}.${data.airport.terminal} 
...
//             ${data.time.currentDate} 
//             ${data.aircraft.layout}${data.aircraft.type} 
//             ${data.time.originTimeMain}${data.airport.nameArrival}
//             ${data.flight.flightType}/${PHRASE_TERMINAL_DEPARTURE}.${data.airport.terminal} 
//             ${PHRASE_AIRCRAFT_REGISTRATION}${data.aircraft.number}/
//             `;
//         }
...
//             ${AC_ICAO_CODE}${data.flight.flightNumberMain}
//             ${data.time.currentDate}
//             ${data.airport.nameArrival}${data.time.correctionTimeMain}
//             ${data.flight.flightType}/${PHRASE_TERMINAL_ARRIVAL}.${data.airport.terminal}
//             ${PHRASE_AIRCRAFT_REGISTRATION}.${data.aircraft.number}/
//     `;
//         }
...
//           ${AC_ICAO_CODE}${data.flight.flightNumberMain}
//           ${data.time.currentDate}
//           ${data.time.originMain}${data.airport.nameArrival}
//           ${data.flight.flightType}/${PHRASE_TERMINAL_ARRIVAL}.${data.airport.terminal}
//           ${PHRASE_AIRCRAFT_REGISTRATION}.${data.aircraft.number}/
